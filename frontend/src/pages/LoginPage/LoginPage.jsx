...
//                 localStorage.setItem('authToken', response.data.token);// Save the user info and token if needed
...
// </a>
//                 <div className="sign-txt">Not yet a member? <a href="/register">Signup now</a></div>
//             </div>
//         </div>
//     );
// }
