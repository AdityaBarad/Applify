...
//     try {
//       const response = await fetch('http://localhost:5000/api/puppeteer/apply', {
//         method: 'POST',
//         headers: {
...
//         alert('Job automation started successfully!');
//       } else {
...
//         // Display success message after jobs are applied
...
//           <div className="spinner"></div>
//           <div>Submitting... Please wait</div>
//           <div>Jobs Applied: {jobsApplied}</div> {/* Display real-time job progress */}
//         </div>
//       ) : (
//         <form onSubmit={handleSubmit}>
//           <label>
...
//         setIsButtonDisabled(false);  //set true for limiting
//       } else {
